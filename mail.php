...
$site_top = "http://www.value-agent.co.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "a.toba@value-agent.co.jp";
...
$Referer_check_domain = "ssl-lolipop.jp";
...
$thanksPage = "https://lolipop-dp56120165.ssl-lolipop.jp/diagnose/thanks.html";
...
$require = array('corp_name','Email','address','phone','datepicker','datepicker2');
...
──────────────────────
株式会社バリュー・エージェント　法人営業部
〒101-0047 東京都千代田区内神田1-10-1 　平富ビル5F　
TEL：03- 3233 - 2700 　FAX：03- 3233 - 2704
フリーダイヤル：0120 - 935 - 889 　
URL: http://www.value-agent.co.jp/
──────────────────────
...
//差出人に届くメールをセット
$_POST['out_name'] = $_POST['corp_name']." ".$_POST['charge'];
